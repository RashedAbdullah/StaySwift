...
import imageOneBig from "@/public/iamge-1.png";
          ...
          <div className="col-span-3 space-y-4">
            ...
            <div>
              ...
              <form action="" className="flex flex-col gap-2 mt-2">
                ...
                <label htmlFor="range3">
                  <input type="checkbox" name="range3" id="range3" />$ 97 - $
                  152
                </label>

                <label htmlFor="range4">
                  <input type="checkbox" name="range4" id="range4" />$ 152 - $
                  182
                </label>
            ...
            <div>
              ...
              <form action="" className="flex flex-col gap-2 mt-2">
                ...
                <label htmlFor="threeStar">
                  <input type="checkbox" name="threeStar" id="threeStar" />3
                  Star
                </label>
